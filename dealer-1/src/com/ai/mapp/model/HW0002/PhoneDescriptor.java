...
**/
public class PhoneDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PhoneDescriptor() {
        ...
        //-- _listPic
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_listPic", "ListPic", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Phone target = (Phone) object;
                    target.setListPic( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- _product
        desc = new XMLFieldDescriptorImpl(Product.class, "_product", "Product", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Phone target = (Phone) object;
                    target.setProduct( (Product) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.ai.mapp.model.HW0002.PhoneDescriptor()
    ...
    **/
    ...
    {
        return com.ai.mapp.model.HW0002.Phone.class;
