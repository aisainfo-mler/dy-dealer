...
public class ResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ResponseDescriptor() {
        ...
        //-- _gender
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_gender", "Gender", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
        ...
        //-- _phoneNumber
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_phoneNumber", "PhoneNumber", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Response target = (Response) object;
                    target.setPhoneNumber( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _phoneNumber
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setMaxLength(100);
        ...
        //-- _postCode
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_postCode", "PostCode", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
        ...
        //-- _creatTime
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_creatTime", "CreatTime", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Response target = (Response) object;
                    target.setCreatTime( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _creatTime
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setMaxLength(100);
        ...
        //-- _productList
        desc = new XMLFieldDescriptorImpl(ProductList.class, "_productList", "ProductList", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Response target = (Response) object;
                    target.setProductList( (ProductList) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.ai.mapp.model.HW0007.ResponseDescriptor()
    ...
    **/
    ...
    {
        return com.ai.mapp.model.HW0007.Response.class;
