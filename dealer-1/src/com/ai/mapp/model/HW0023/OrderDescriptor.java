...
public class OrderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OrderDescriptor() {
        ...
        //-- _commissionCode
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_commissionCode", "CommissionCode", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Order target = (Order) object;
                return target.getCommissionCode();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Order target = (Order) object;
                    target.setCommissionCode( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _commissionCode
        fieldValidator = new FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator sv = new StringValidator();
        ...
        //-- _commissionId
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_commissionId", "CommissionId", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Order target = (Order) object;
                    target.setCommissionId( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _commissionId
        fieldValidator = new FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator sv = new StringValidator();
        ...
        //-- _chargeType
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_chargeType", "ChargeType", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Order target = (Order) object;
                    target.setChargeType( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _chargeType
        fieldValidator = new FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator sv = new StringValidator();
    ...
    } //-- com.ai.mapp.model.HW0023.OrderDescriptor()
    ...
    **/
    ...
    {
        return com.ai.mapp.model.HW0023.Order.class;
