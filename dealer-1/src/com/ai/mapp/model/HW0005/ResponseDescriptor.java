 ...
 * XML Schema.
 * $Id: ResponseDescriptor.java,v 1.1 2012/03/16 09:42:37 luyang2 Exp $
 */
...
public class ResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ResponseDescriptor() {
        ...
        //-- _areaId
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_areaId", "AreaId", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Response target = (Response) object;
                    target.setAreaId( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.ai.mapp.model.Z10001.ResponseDescriptor()
    ...
    **/
    ...
    {
        return com.ai.mapp.model.HW0005.Response.class;
