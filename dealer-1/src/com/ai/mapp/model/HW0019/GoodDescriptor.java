...
public class GoodDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GoodDescriptor() {
        ...
        //-- _goodStatus
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_goodStatus", "GoodStatus", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Good target = (Good) object;
                    target.setGoodStatus( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _goodStatus
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setMaxLength(100);
        ...
        //-- _image
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_image", "Image", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
    ...
    } //-- com.ai.mapp.model.HW0019.GoodDescriptor()
    ...
    **/
    ...
    {
        return com.ai.mapp.model.HW0019.Good.class;
