...
public class ResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ResponseDescriptor() {
        ...
        //-- _itemList
        desc = new XMLFieldDescriptorImpl(ItemList.class, "_itemList", "ItemList", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Response target = (Response) object;
                    target.setItemList( (ItemList) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.ai.mapp.model.HW0014.ResponseDescriptor()
    ...
    **/
    ...
    {
        return com.ai.mapp.model.HW0014.Response.class;
