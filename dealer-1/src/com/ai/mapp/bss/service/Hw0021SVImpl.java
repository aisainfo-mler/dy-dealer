...
@Service(value="hw0021Service")
@Scope(value="singleton")
public class Hw0021SVImpl extends ISVTemplate {
	...
	protected Object convertResponse(ParamObject param) throws Exception {
		com.ai.mapp.model.HW0021.Response rsp = new com.ai.mapp.model.HW0021.Response();
	...
	protected ParamObject send(ParamObject param) throws Exception {
		...
		com.ai.mapp.model.HW0021.Request req = com.ai.mapp.model.HW0021.Request
			.unmarshal(new StringReader((String)param.getParameter(BSSConstantParam.REQUESTCONTENT)));
		
		orderInfoService.payOrderInfo(req.getOrderCode(), req.getPayMode(), req.getVoucherNo());
