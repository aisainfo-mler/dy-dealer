...
public class ConvertUtils {
	 ...
	 */
	public static String fillSpace(String str,int length) throws UnsupportedEncodingException
	{
		if(str == null || "null".equals(str.trim())) str ="";
...
//		System.out.println(str+" 不齐空格长度："+fill_length);
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public static String fillLeftSpace(String str,int length) throws UnsupportedEncodingException
	{
		if(str == null) str ="";
	...
	public static String convertSplitStrToOracleCondition(String splitStr,String split){
