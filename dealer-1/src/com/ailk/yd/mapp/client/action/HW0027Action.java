...
/**
 * @author Zhengwj 
 * @version 创建时间：2014-5-7 上午11:13:08
 * 类说明:代理商充值接口
 */
...
@Scope("prototype")
public class HW0027Action extends AbstractYDBaseActionHandler<HW0027Request, HW0027Response>{
...
//		Collection<AccountInfo> accountInfos = accountInfoService.loadAccountInfoByOperatorId(1L);
		...
		if(accountInfos != null && accountInfos.size() != 0){
			...
			accountLog.setIncome(this.request.getAmount() == null ? 0:this.request.getAmount().longValue());
...
//				YDDatapackage pkg = sendMsg("yd0013", ydReq, sessionId);
			...
			throw new BusinessException(ErrorCodeDefine.EXPECT_ERROR,"该代理商未创建本地账户");
		}
