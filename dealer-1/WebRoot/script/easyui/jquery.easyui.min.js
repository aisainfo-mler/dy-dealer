...
if(e.data.startPosition == "relative"){
	$(e.data.target).css({position:e.data.startPosition,left:'0px',top:'0px'});
}else{
...
_1bc.mask=$("<div class=\"window-mask\"><iframe class=\"window-mask-frame\" frameborder=\"0\" style=\"filter:alpha(opacity=01);opacity:.01;background:#000;\"/></div>").insertAfter(_1bc.window);
...
//$("body>div.window-mask>.window-mask-frame").css({width:(_1bc.options.inline?_1bc.mask.parent().width():_1bf().width),height:(_1bc.options.inline?_1bc.mask.parent().height():_1bf().height)});
var iframe_ =  $(".window-mask-frame");
iframe_.css("width",iframe_.parent().css("width"));
iframe_.css("height",iframe_.parent().css("height"));
}
if(_1bc.shadow){
_1bc.shadow.remove();
}
...
$("body>div.window-mask>.window-mask-frame").css({width:$(window).width(),height:$(window).height()});
setTimeout(function(){
$("body>div.window-mask").css({width:_1bf().width,height:_1bf().height});
$("body>div.window-mask>.window-mask-frame").css({width:_1bf().width,height:_1bf().height});
},50);
});
