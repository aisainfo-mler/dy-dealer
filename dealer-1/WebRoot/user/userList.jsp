...
<table cellspacing="0" cellpadding="0" class="listTable">
 <thead>
	<tr>
		...
		<th nowrap><s:text name="user.createTime" /></th>
...
<%--				</td>--%>
				<td colspan="7">
					...
					<br/>
					<div align="center">
						<input type="button" class="d_button6" value="<s:text name="common.pass" />" onclick="user_change_status(<s:property value="%{#userUnit.userId}"/>,<s:property value="#stateValid"/>,'<s:text name="user.passAudit" />')"/>
						<input type="button" class="d_buttonThin6" value="<s:text name="common.noPass" />" onclick="user_change_status(<s:property value="%{#userUnit.userId}"/>,<s:property value="#stateInvalid"/>,'<s:text name="user.noPassAudit" />')"/>
					</div>
				</td>
			</tr>
		</s:iterator>	
