...
<head>
	...
	<script type="text/javascript" src="<s:url value='/script/jquery-ui.min.js'/>"></script>
	<%
...
<div class="header">
  	...
  	<div class="language">
		...
		<s:if test="%{#indexLang == null || #indexLang == '' || #indexLang == 'en_US'}">
...
<div class="mainBody">
	...
	<div class="loginBox">
		<h1><s:property value="getText('index.userLogin')" /></h1>
		<form id="login" action="<s:url value='/common/check.do?request_locale=zh_CN' />" method="post" >
		<div class="loginCon">
			<ul>
				<li class="user">
					<input id="username" name="username" type="text" placeholder="<s:property value="getText('index.inputUserName')" />" onfocus="this.style.color='#000';this.value=''" autofocus required />
				</li>
				<li class="password">
					<input id="password" name="password" type="password" value="" placeholder="<s:property value="getText('index.inputPassword')" />" onfocus="this.style.color='#000';this.value=''" required />
				</li>
			</ul>
			<div class="loginBtn" style="margin: 30px 0 0;">
				<input type="button" id="submit1" onclick="checkLogin(1);" value="<s:property value="getText('index.login')" />"/>
				<div class="loadingBig" style="margin: 10px 0; background-position: 25% 0;color:#000;display:none"><s:property value="getText('index.logining')" /></div>
			</div>
		</div>
		</form>
	</div>
...
<div class="footer">
	<div class="footerCon">
		<div class="supportSevice">
			<h3><s:property value="getText('foot.support')" /></h3>
			<ul>
		...
		<div class="copyright">
			<s:text name="asiaCoTitle" /><br/>
			© 2012 AsiaInfo-Linkage Company. All right Reserved.
		</div>
